...
int UART0_Set(int fd, int speed, int flow_ctrl, int databits, int stopbits, int parity)
{
	int i;
	int status;
	int speed_arr[] = {B4000000, B3500000, B3000000, B1500000, B921600, B115200, B19200, B9600, B4800, B2400, B1200, B300};
	int name_arr[] = {4000000, 3500000, 3000000, 1500000, 921600, 115200, 19200, 9600, 4800, 2400, 1200, 300};
